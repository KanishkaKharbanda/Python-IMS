...
class productClass:
    def __init__(self,root):
        ...
        txt_name=Entry(product_Frame,textvariable=self.var_price,font=("goudy old style",15),bg="lightyellow").place(x=150,y=210,width=200)
        txt_name=Entry(product_Frame,textvariable=self.var_qty,font=("goudy old style",15),bg="lightyellow").place(x=150,y=260,width=200)
        ...
        self.ProductTable.heading("pid",text="ProductID")
